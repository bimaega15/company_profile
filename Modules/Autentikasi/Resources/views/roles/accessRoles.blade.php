                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input check-input-roles" type="checkbox" value="{{$item->id}}" id="id_{{$item->id}}" data-id="{{$item->id}}" data-url="{{ url('autentikasi/assignRoles') }}" data-role_id="{{$role->id}}">
