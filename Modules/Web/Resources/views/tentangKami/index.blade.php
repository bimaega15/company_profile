            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    <button class="btn btn-primary btn-icon btn-round hidden-sm-down float-right m-l-10 btn-add"
                        type="button" data-url="{{ route('web.tentangKami.create') }}">
                                    ...
                                    <div class="card shadow">
                                        ...
                                        <div class="body">
                                            <div class="d-flex flex-column">
                                                <div>
                                                    <button class="w-100 btn btn-primary btn-tab-data"
                                                        data-view="tentang_kami">
                                                        TENTANG KAMI
                                                    </button>
                                                </div>
                                                <div>
                                                    <button class="w-100 btn btn-light btn-tab-data"
                                                        data-view="profile_singkat">
                                                        PROFILE SINGKAT TIM
                                                    </button>
                                                </div>
                                            </div>
