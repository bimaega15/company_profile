<h6 style="text-transform: capitalize; font-size:17px;">Profil Perusahaan</h6>
...
<br>
<h6 style="text-transform: capitalize; font-size:17px;">Pengaturan Media Sosial</h6>
<div style="width: 100%; height: 1px; background-color: #868686; margin-bottom: 15px;"></div>
<div class="form-group">
...
<br>
<h6 style="text-transform: capitalize; font-size:17px;">Pengaturan Bahasa & Logo</h6>
<div style="width: 100%; height: 1px; background-color: #868686; margin-bottom: 15px;"></div>
<div class="row">
    <div class="col-lg-6">
        <div class="form-group">
                ...
                @if ($settings != null)
                    <div id="load_logo_settings">
                        <a class="photoviewer" href="{{ asset('upload/settings/logo/' . $settings->logo_settings) }}"
                            ...
                            <br>
                            <img src="{{ asset('upload/settings/logo/' . $settings->logo_settings) }}"
                ...
                @if ($settings != null)
                    <div id="load_icon_settings">
                        <a class="photoviewer" href="{{ asset('upload/settings/icon/' . $settings->icon_settings) }}"
                            ...
                            <br>
                            <img src="{{ asset('upload/settings/icon/' . $settings->icon_settings) }}"
                                alt="upload gambar" height="100px" class="rounded">
                        </a>
                    </div>
                @endif
                ...
                @if ($settings != null)
                    <div id="load_perusahaan_settings">
                        <a class="photoviewer"
                            ...
                            data-gallery="photoviewer" data-title="{{ $settings->perusahaan_settings }}"
                            target="_blank">
                            <br>
