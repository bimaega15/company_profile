...
<table style="width: 100%; background-color: #4F4A45;">
    <tr>
        <td style="padding: 10px; text-align: center;">
            <table style="width: 100%;">
                <tr>
                    <td style="text-align: center;">
                        <img src="{{ asset('upload/settings/perusahaan/'.UtilsHelp::settingApp()->perusahaan_settings) }}" alt="Upload logo perusahaan" height="150px;" style="border-radius: 10px;">
                    </td>
                </tr>
                <tr>
                    <td style="padding-top: 30px;">
                        <table style="margin: 0 auto; padding: 50px; background-color: #0F0F0F; border-radius: 10px; box-shadow: 5px 3px 15px -1px #F1EFEF">
                            <tr>
                ...
                <tr>
                    <td style="padding: 20px; padding-top: 40px; text-align: center; color: #fff;">&copy; {{ UtilsHelp::settingApp()->setting_copyright }}
                    </td>
                </tr>
            </table>
        </td>
