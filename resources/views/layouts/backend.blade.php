...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('backend/html') }}/assets/plugins/jvectormap/jquery-jvectormap-2.0.3.min.css" />
    ...
    <link rel="stylesheet"
        href="{{ asset('library/') }}/DataTables/DataTables-1.13.6/css/dataTables.bootstrap4.min.css">
    ...
    <link
        href="{{ asset('backend/html') }}/assets/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css"
        rel="stylesheet" />
...
<body class="theme-cyan">
    ...
    <script src="{{ asset('backend/htmlassets/plugins/ckeditor/ckeditor.js') }}"></script>
    ...
    <script
        src="{{ asset('backend/html') }}/assets/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js">
    </script>
