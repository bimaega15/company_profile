                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img class="rounded avatar" src="{{ asset('backend/html/') }}/assets/images/xs/avatar1.jpg" alt="">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img class="rounded avatar" src="{{ asset('backend/html/') }}/assets/images/xs/avatar2.jpg" alt="">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img class="rounded avatar" src="{{ asset('backend/html/') }}/assets/images/xs/avatar10.jpg" alt="">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img class="rounded avatar" src="{{ asset('backend/html/') }}/assets/images/xs/avatar4.jpg" alt="">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <img class="rounded avatar" src="{{ asset('backend/html/') }}/assets/images/xs/avatar5.jpg" alt="">
                                            </td>
                                            <td>
                                            ...
                                            <td class="hidden-md-down">
                                                <ul class="list-unstyled team-info  margin-0">
                                                    ...
                                                    <li>
                                                        <img src="{{ asset('backend/html/') }}/assets/images/xs/avatar1.jpg" alt="Avatar">
                                                    </li>
                                                    <li>
                                                        <img src="{{ asset('backend/html/') }}/assets/images/xs/avatar2.jpg" alt="Avatar">
                                                    </li>
                        ...
                        <div class="city-selected body l-salmon">
                            <div class="row">
                                ...
                                <div class="icon col-5">
                                    <img src="{{ asset('backend/html/') }}/assets/images/weather/summer.svg" alt="">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="carousel-item text-center active">
                                    <div class="col-12">
                                        <ul class="row days-list list-unstyled">
                                            <li class="day col-4">
                                                <p>Monday</p>
                                                <img src="{{ asset('backend/html/') }}/assets/images/weather/rain.svg" alt="">
                                            </li>
                                            <li class="day col-4">
                                                <p>Tuesday</p>
                                                <img src="{{ asset('backend/html/') }}/assets/images/weather/cloudy.svg" alt="">
                                            </li>
                                            <li class="day col-4">
                                                <p>Wednesday</p>
                                                <img src="{{ asset('backend/html/') }}/assets/images/weather/wind.svg" alt="">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="carousel-item text-center">
                                    <div class="col-12">
                                        <ul class="row days-list list-unstyled">
                                            <li class="day col-4">
                                                <p>Thursday</p>
                                                <img src="{{ asset('backend/html/') }}/assets/images/weather/sky.svg" alt="">
                                            </li>
                                            <li class="day col-4">
                                                <p>Friday</p>
                                                <img src="{{ asset('backend/html/') }}/assets/images/weather/cloudy.svg" alt="">
