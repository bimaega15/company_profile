                    ...
                    <div class="col-md-6 col-lg-5">
                        <div class="login-box bg-white box-shadow border-radius-10">
                            <div class="login-title">
                                <h2 class="text-center text-primary" style="font-size: 18px;">Reset Password</h2>
                            </div>
                            ...
                            <form method="post" action="{{ route('forgotPassword.storeResetPassword') }}">
                                ...
                                {{-- <div class="select-role">
                                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                        <label class="btn" style="background-color: #F3F2FF; border-color: #cecaff;">
                                            ...
                                            <div class="icon"><img
                                                    src="{{ asset('frontend') }}/vendors/images/person.svg"
                                                    class="svg" alt=""></div>
                                            <span>I'm</span>
                                            Employee
                                        </label>
                                ...
                                <div class="input-group custom">
                                    <input class="form-control form-control-lg" type="password" name="password"
                                        ...
                                        style="font-size: 16px; height: 47px;">
                                    <div class="input-group-append custom">
                                        <span class="input-group-text"><i class="dw dw-unlock"></i></span>
                                ...
                                @enderror
                                <div class="input-group custom">
                                    <input class="form-control form-control-lg" type="password" name="password_confirm"
